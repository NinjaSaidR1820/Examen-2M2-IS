    ...
    public class RAFContext
    {
        ...
        public void Create<T>(T t)
        {
            try
            {
                ...
                {
                    int n, k;
                    using (System.IO.BinaryReader brHeader = new System.IO.BinaryReader(bwHeader.BaseStream))
                    {
        ...
        public T Get<T>(int id) 
        {
            try
            {
                ...
                using (System.IO.BinaryReader brHeader = new System.IO.BinaryReader(HeaderStream),
                                    BrData = new System.IO.BinaryReader(DataStream))
                {
